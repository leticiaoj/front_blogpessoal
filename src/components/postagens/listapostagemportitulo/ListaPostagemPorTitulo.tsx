        ...
        <>
            <form action="" onSubmit={onSubmit}>
                <Box display="flex" justifyContent="center" alignItems="center" marginTop={2} marginBottom={2} width="100%">
                    ...
                    />
                    <Box mx={1}>
                        <Button type="submit" variant="contained" size='medium' className="botao"
                            ...
                            <CardActions>
                                <Box display="flex" justifyContent="center" mb={1.5}>
                                    ...
                                    <Link to={`/formularioPostagem/${post.id}`} className="text-decorator-none" >
                                        <Box mx={1}>
                                            <Button variant="contained" size='small' className="att">
                                                Atualizar
                                            </Button>
                                        </Box>
                                    </Link>
                                    <Link to={`/deletarPostagem/${post.id}`} className="text-decorator-none">
                                        <Box mx={1}>
                                            <Button variant="contained" size='small' className="del">
                                                Deletar
                                            </Button>
                                        </Box>
                                    </Link>
